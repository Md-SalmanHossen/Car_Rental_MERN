              ...
              bookings.map((booking,index)=>(
                <tr key={index} className="border-t border-borderColor text-gray-500">
                  ...
                  <td className="p-3 flex items-center gap-3">
                    <img className="h-12 w-12 aspect-square rounded-md object-cover" src={booking.car.image} alt="" />
                    <div className="max-md:hidden">
                      <p className="font-medium">{booking.car.brand} {booking.car.model}</p>
                      <p className="text-xs text-gray-500">{booking.seating_capacity} . {booking.transmission}</p>
                    </div>
                  </td>
