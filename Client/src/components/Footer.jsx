...
const Footer = () => {
   return (
      <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
         ...
         <div className='flex flex-wrap justify-between gap-12 md:gap-6 pb-6 border-borderColor border-b'>
            <div >
               ...
               <div className='flex items-center gap-3 mt-6'>
                  <a href="#"><img src={assets.facebook_logo} className='w-5 h-5' alt="icon" /></a>
                  <a href="#"><img src={assets.instagram_logo} className='w-5 h-5' alt="icon" /></a>
                  <a href="#"><img src={assets.twitter_logo} className='w-5 h-5' alt="icon" /></a>
                  <a href="#"><img src={assets.gmail_logo} className='w-5 h-5' alt="icon" /></a>
               </div>
            </div>
